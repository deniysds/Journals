...
@section('content')
    <div class="grid w-full space-y-5">
        <div class="kt-card">
            <div class="kt-card-header min-h-16 flex-wrap py-5">
                ...
                <div class="flex items-center gap-2.5">
                    <input type="text" placeholder="{{ __('journals::app.search') }}" class="kt-input sm:w-48"
                        id="search_members" data-kt-datatable-search="#kt_datatable_editorial_boards" />
                    ...
                    <a class="kt-btn kt-btn-sm kt-btn-outline" id="export_btn" href="{{ route('editorial-boards.export') }}"
                        target="_blank">
            ...
            <div id="kt_datatable_editorial_boards" class="kt-card-table" data-kt-datatable-page-size="10"
                            ...
                            <tr>
                                ...
                                <th scope="col" class="w-48" data-kt-datatable-column="name">
                                    <span class="kt-table-col"><span
                                            class="kt-table-col-label">{{ __('journals::app.member_name') }}</span><span
                                            class="kt-table-col-sort"></span></span>
                                </th>
                                <th scope="col" class="w-48" data-kt-datatable-column="journal">
                                    <span class="kt-table-col"><span
                                            class="kt-table-col-label">{{ __('journals::app.journal') }}</span><span
                                            class="kt-table-col-sort"></span></span>
                                </th>
                                <th scope="col" class="w-36" data-kt-datatable-column="role">
                                    <span class="kt-table-col"><span
                                            class="kt-table-col-label">{{ __('journals::app.role') }}</span><span
                                            class="kt-table-col-sort"></span></span>
                                </th>
                                <th scope="col" class="w-48" data-kt-datatable-column="affiliation">
                                    <span class="kt-table-col"><span
                                            class="kt-table-col-label">{{ __('journals::app.affiliation') }}</span><span
                                            class="kt-table-col-sort"></span></span>
                                </th>
                                <th scope="col" class="w-40" data-kt-datatable-column="email">
                                    <span class="kt-table-col"><span
                                            class="kt-table-col-label">{{ __('journals::app.email') }}</span><span
                                            class="kt-table-col-sort"></span></span>
                                </th>
        ...
        <div class="bg-white rounded-xl shadow-xl w-full max-w-lg overflow-hidden">
            ...
            <form action="{{ route('editorial-boards.store') }}" method="POST" class="p-6 space-y-4">
                ...
                <div class="space-y-1.5">
                    <label class="kt-label font-medium text-gray-700">{{ __('journals::app.journal') }} <span
                ...
                <div class="space-y-1.5">
                    <label class="kt-label font-medium text-gray-700">{{ __('journals::app.role') }} <span
                            class="text-danger-600">*</span></label>
                    <select name="role" class="kt-select w-full" required>
                        ...
                        <option value="Editorial Board Member" selected>{{ __('journals::app.editorial_board_member') }}
                        </option>
                ...
                <div class="space-y-1.5">
                    <label class="kt-label font-medium text-gray-700">{{ __('journals::app.member_name') }} <span
                            class="text-danger-600">*</span></label>
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="affiliation" class="kt-input w-full"
                        placeholder="misal: Universitas / Lembaga Riset" />
                </div>
                ...
                var datatable = new KTDataTable(datatableEl, {
                    ...
                    columns: {
                        ...
                        actions: {
                            render: function (value, row) {
                                if (!row) return '';
                                return '<div class="flex items-center justify-center gap-1.5"><button type="button" onclick="deleteMember(' + row.id + ')" class="kt-btn kt-btn-xs kt-btn-icon kt-btn-ghost text-danger" title="Delete"><i class="ki-filled ki-trash text-danger text-base"></i></button></div>';
                            }
                        }
                    },
                    callbacks: {
